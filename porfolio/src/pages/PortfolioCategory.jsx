...
export default function PortfolioCategory({ category }) {
  ...
  // Cada vez que cambie la categoría, reiniciamos el contador a 6
  useEffect(() => {
    setVisibleCount(6);
  }, [category]);
  ...
  // Cortamos el array para mostrar solo los permitidos por visibleCount
    ...
    <div className="bg-white min-h-screen pt-32 px-6 md:px-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
        {displayProjects.map((project) => (
          <div key={project.id} className="group overflow-hidden bg-gray-100 aspect-square relative cursor-pointer">
            <img 
              src={project.image} 
              alt={project.title}
      ...
      {/* BOTÓN LOAD MORE (Basado en tu imagen) */}
      {visibleCount < allFilteredProjects.length && (
        <div className="flex justify-center items-center py-20">
          ...
          >
            ...
            {/* Círculo con el punto central de tu referencia */}
