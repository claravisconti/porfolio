export default function Terms() {
  return (
    <div className="py-20 max-w-3xl mx-auto">
      <h2 className="text-content text-4xl font-black mb-8 italic uppercase tracking-tighter">
        Terms <span className="text-accent">&</span> Conditions
      </h2>
      
      <div className="space-y-8 text-muted leading-relaxed">
        <section>
          <h3 className="text-content font-bold text-lg mb-2 uppercase tracking-widest">1. Uso del Sitio</h3>
          <p>
        ...
        <section>
          <h3 className="text-content font-bold text-lg mb-2 uppercase tracking-widest">2. Propiedad Intelectual</h3>
          <p>
        ...
        <section>
          <h3 className="text-content font-bold text-lg mb-2 uppercase tracking-widest">3. Limitación de Responsabilidad</h3>
          <p>
        ...
        <section>
          <h3 className="text-content font-bold text-lg mb-2 uppercase tracking-widest">4. Enlaces a Terceros</h3>
          <p>
