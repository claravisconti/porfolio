export default function Privacy() {
  return (
    <div className="py-20 max-w-3xl mx-auto">
      <h2 className="text-content text-4xl font-black mb-8">Privacy Policy</h2>
      
      <div className="space-y-6 text-muted leading-relaxed">
        <section>
          <h3 className="text-content font-bold text-xl mb-2">1. Información General</h3>
          <p>
        ...
        <section>
          <h3 className="text-content font-bold text-xl mb-2">3. Cookies</h3>
          <p>
        ...
        <section>
          <h3 className="text-content font-bold text-xl mb-2">4. Propiedad Intelectual</h3>
          <p>
