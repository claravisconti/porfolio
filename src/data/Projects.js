...
const rawProjects = [
  ...
  // --- CAMPAÑAS ---
  {
    ...
    slug: "fidelity",
    year: "2023",
    services: "Estrategia Digital / Dirección de Arte Social",
    problem: "La necesidad de comunicar insights complejos sobre el futuro del retail en plataformas sociales sin perder la sofisticación de una consultora de marca de alto nivel.",
    objective: "Diseñar una narrativa visual para Instagram que posicione a la marca como líder de pensamiento, transformando datos de mercado en una experiencia estética inmersiva y de alto impacto.",
    challenge: "Lograr que conceptos abstractos como 'Experiential' o 'Value-led' se sientan humanos y tangibles a través de una dirección de arte que equilibre la fotografía cinematográfica con una tipografía técnica.",
    solution: "Se implementó un sistema de diseño 'Social-Editorial' utilizando una paleta de tonos profundos y desaturados, tipografías sans-serif de estilo suizo y un uso estratégico de sombras y texturas que elevan el contenido educativo a una pieza de diseño aspiracional.",
    colors: ["#1A1A1A", "#8C8C7E", "#FFFFFF"],
    fonts: "Plus Jakarta Sans / Inter",
    metrics: [
      { name: "Posicionamiento de Marca", percentage: 94 },
      { name: "Engagement Editorial", percentage: 88 },
      { name: "Claridad de Concepto", percentage: 92 },
      { name: "Consistencia Visual", percentage: 98 },
    ],
    impact: [
      { label: "Interacción", value: "+45%" },
  ...
  },
  {
    ...
    slug: "consumerPulse",
    year: "2025",
    services: "Data Visualization / Estrategia de Contenido",
    problem: "La dificultad de sintetizar informes macroeconómicos densos en piezas de contenido ágiles y atractivas para la toma de decisiones B2B.",
    objective: "Transformar datos estadísticos complejos sobre inflación, IA y consumo en una narrativa visual impactante que fomente la conversación en redes profesionales.",
    challenge: "Humanizar los datos logísticos y económicos mediante una dirección de arte disruptiva que evite los gráficos estadísticos convencionales.",
    solution: "Se diseñó un ecosistema de visualización basado en renders 3D isométricos y tipografía de gran escala (Mega-type). El uso de metáforas visuales, como el mapa de contenedores, permite comunicar conceptos de comercio global de forma instantánea y memorable.",
    colors: ["#1F5D6B", "#D1E3E2", "#FFFFFF", "#F2F2F2"],
    fonts: "Plus Jakarta Sans / Inter",
    metrics: [
      { name: "Claridad de Datos", percentage: 96 },
      { name: "Impacto Visual", percentage: 94 },
      { name: "Retención de Información", percentage: 89 },
      { name: "Shareability B2B", percentage: 92 },
    ],
    impact: [
  ...
  },
  {
    ...
    slug: "consumer",
    year: "2022",
    services: "Estrategia de Diseño Social / Dirección de Arte",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Eficiencia de Producción", percentage: 95 },
      { name: "Coherencia de Marca", percentage: 98 },
      { name: "Impacto Visual (Stop-scroll)", percentage: 92 },
      { name: "Adaptabilidad Regional", percentage: 90 },
    ],
    impact: [
      { label: "Producción Gráfica", value: "+50%" },
  ...
  },
  {
    ...
    slug: "trueLoyalty",
    year: "2017",
    services: "Dirección Artística / Behavioral Design",
    ...
    fonts: "Plus Jakarta Sans / Inter",
    metrics: [
      { name: "Conexión Emocional", percentage: 95 },
      { name: "Sintonización en Tiempo Real", percentage: 88 },
      { name: "Retención de Clientes", percentage: 92 },
      { name: "Innovación Percibida", percentage: 90 },
    ],
    impact: [
      { label: "NPS del Banco", value: "+40%" },
  ...
  },
  {
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Impacto en el Evento", percentage: 95 },
      { name: "Consistencia Multi-pantalla", percentage: 98 },
      { name: "Engagement del Sector", percentage: 92 },
      { name: "Innovación Visual", percentage: 94 },
    ],
    impact: [
      { label: "Lugar", value: "Los Angeles" },
  ...
  },
  {
    ...
    slug: "drupal",
    year: "2016",
    services: "Branding de Comunidad / Diseño Social",
    ...
    fonts: "Plus Jakarta Sans / Inter",
    metrics: [
      { name: "Impacto en la Comunidad", percentage: 95 },
      { name: "Modernización de Marca", percentage: 92 },
      { name: "Reconocimiento de Hito", percentage: 100 },
      { name: "Engagement Social", percentage: 88 },
    ],
    impact: [
      { label: "Aniversario", value: "25 Years" },
  ...
  },
  {
    ...
    year: "2023",
    services: "Real-Time Content / Branding de Evento",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Velocidad de Respuesta", percentage: 98 },
      { name: "Dominio de Conversión", percentage: 94 },
      { name: "Calidad de Producción", percentage: 96 },
      { name: "Impacto en Redes", percentage: 91 },
    ],
    impact: [
      { label: "Ubicación", value: "New York, NY" },
  ...
  },
  {
    ...
    slug: "drupalCon",
    year: "2021",
    services: "Identidad de Evento / Diseño de Información",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Claridad Informativa", percentage: 97 },
      { name: "Asistencia Record", percentage: 100 },
      { name: "Coherencia Visual", percentage: 95 },
      { name: "Impacto en Redes", percentage: 89 },
    ],
    impact: [
      { label: "Temática", value: "AI Search Era" },
  ...
  },
  {
    ...
    slug: "iwd",
    year: "2026",
    services: "Diseño de Impacto Social / Dirección de Arte",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Nivel de Compartición", percentage: 98 },
      { name: "Representación de Diversidad", percentage: 100 },
      { name: "Impacto en Engagement", percentage: 94 },
      { name: "Percepción de Marca", percentage: 92 },
    ],
    impact: [
      { label: "Campaña", value: "International Women's Day" },
  ...
  },
  {
    ...
    slug: "stc",
    year: "2024",
    services: "Estrategia para ONG / Dirección de Arte",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Impacto Visual", percentage: 96 },
      { name: "Conexión Emocional", percentage: 94 },
      { name: "Claridad del Mensaje", percentage: 98 },
      { name: "Reconocimiento de Industria", percentage: 100 },
    ],
    impact: [
      { label: "Premio", value: "Winner Shorty Awards" },
  ...
  },
  {
    ...
    slug: "hcic",
    year: "2026",
    services: "Branding de Salud / Estrategia de Evento",
    ...
    fonts: "Inter / Plus Jakarta Sans",
    metrics: [
      { name: "Claridad Estratégica", percentage: 96 },
      { name: "Impacto de Innovación", percentage: 98 },
      { name: "Consistencia de Marca", percentage: 94 },
      { name: "Engagement del Sector", percentage: 92 },
    ],
    impact: [
      { label: "Ubicación", value: "Las Vegas, NV" },
